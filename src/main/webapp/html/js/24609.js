var dialog_url=new Array({url:"http://sina.cn/nc.php",name:"新闻"},{url:"http://mil.sina.cn/",name:"军事"},{url:"http://news.sina.cn/?sa=t141d50v68",name:"社会"},{url:"http://weibo.cn/?gotoreg=1",name:"微博"},{url:"http://blog.sina.cn/",name:"博客"},{url:"http://news.sina.com.cn/iframe/wap/437/2011/0516/359.html",name:"客户端"},{url:"http://sports.sina.cn/",name:"体育"},{url:"http://lotto.sina.cn/",name:"彩票"},{url:"http://nba.sina.cn",name:"NBA"},{url:"http://finance.sina.cn/",name:"财经"},{url:"http://finance.sina.cn/?sa=d13t60v512",name:"股票"},{url:"http://tech.sina.cn/",name:"科技"},{url:"http://ent.sina.cn/",name:"娱乐"},{url:"http://video.sina.cn",name:"视频"},{url:"http://mp3.sina.cn",name:"MP3"},{url:"http://book.sina.cn",name:"读书"},{url:"http://story.sina.cn/",name:"短篇"},{url:"http://cul.sina.cn/",name:"文史"},{url:"http://eladies.sina.cn/",name:"女性"},{url:"http://style.sina.cn/",name:"尚品"},{url:"http://travel.sina.cn/",name:"旅游"},{url:"http://auto.sina.cn/",name:"汽车"},{url:"http://house.sina.cn/",name:"房产"},{url:"http://view.sina.cn",name:"视野"},{url:"http://ast.sina.cn/",name:"星座"},{url:"http://edu.sina.cn/",name:"校园"},{url:"http://baby.sina.cn/",name:"育儿"},{url:"http://qiwen.sina.cn/",name:"奇闻"},{url:"http://joke.sina.cn/",name:"笑话"},{url:"http://3g.sina.com.cn/3g/site/proc/search/index.php",name:"搜索"},{url:"http://dp.sina.cn/dpool/xweather/index.php",name:"天气"},{url:"http://down.sina.cn/",name:"下载"},{url:"http://3g.sina.com.cn/3g/bst/?sa=t810d1v2863",name:"百事通"},{url:"http://bbs.sina.cn/",name:"论坛"},{url:"http://paper.iask.cn/iask/paper/?vt=4",name:"读报"});var isIDevice=navigator.userAgent.match(/iPhone/i)||navigator.userAgent.match(/iPad/i);var ua_temp=(isIDevice)?"youxi":"game";dialog_url.splice(dialog_url.length-6,0,{url:"http://"+ua_temp+".sina.cn/?wapc=5005",name:"游戏"});function open_dialog_guide(i){var l=document.getElementById("mainpage");var m=document.getElementById("dialog_guide");m.style.display="block";l.style.display="none";var j=document.getElementById("urls");if(j.innerHTML==""){var h="";var k="";for(key in dialog_url){if(dialog_url[key].url){h+='<li><a href="'+add_pos(dialog_url[key].url,i)+'" style="background-position:3px -'+(key*38)+'px;">'+dialog_url[key].name+"</a></li>"}}j.innerHTML=h}}each(document.querySelectorAll(".open_guide"),function(){this.onclick=function(){open_dialog_guide(108)}});each(document.querySelectorAll(".aclose"),function(){var c=this;c.onclick=function(){each(document.querySelectorAll(".dialog"),function(){this.style.display="none"});document.querySelector("#mainpage").style.display="block"}});function add_pos(d,e){if(d.indexOf("?")>=0){d=d+"&amp;"}else{d=d+"?"}return d+"pos="+e}var f_interface="";function friend_read_init(){if(!sid||!gsid||!uid){var c=f_interface+"?call_back=getFriendReadData&no_html=1&source=sinacn"}else{var c=f_interface+"?user_id="+uid+"&auth_type=2&skey="+sid+"&auth_key="+gsid+"&call_back=getFriendReadData&no_html=1&source=sinacn"}createScript(c)}function getFriendReadData(f){if(!f){return false}else{var g="";g+='<div class="bar_nav b_top">';g+='<ul><li class="onlychild on"><a href="http://view.sina.cn/h5/friend.php?view_back=sinacms&pos=108">好友阅读</a></li></ul><p class="top"><a href="#top" title="返回顶部"></a></p></div>';g+='<div class="nav_content_list"><div class="nav_content_item"><ul class="news_list">';for(key in f){g+='<li><a href="'+f[key]["url"]+'">'+cutstr(f[key]["title"],24)+"</a></li>"}g+='</ul><div class="list_more"><a href="http://view.sina.cn" title="进入新浪视野">进入新浪视野 &gt;&gt;</a></div></div></div>';var e=document.querySelector("#friend_read");e.innerHTML=g}}var t_interface="";function user_ttt_init_sina_cn(){if(!sid||!gsid){return false}var c=t_interface+"?type=js&c=sina_cn&s="+sid+"&unixtimestamp="+timestamp+"&gsid="+gsid+"&callback=get_data_from_json";createScript(c)}function get_data_from_json(b){if(typeof b.errno!="undefined"){return false}else{var e=Number(b.comment)+Number(b.message)+Number(b.notice)+Number(b.atmsg)+Number(b.atcmt)+Number(b.newfans);create_wb_html(e)}}function create_wb_html(d){var e=document.querySelector("#wb_cnt");if(d>0){message_html=(d>99)?"99+":d;message_html="<em>"+message_html+"</em>";e.innerHTML="微博"+message_html}}function addLoadEvent(d){var e=window.onload;if(typeof window.onload!="function"){window.onload=d}else{window.onload=function(){e();d()}}}function createScript(e){var g=document.createElement("script");g.src=e;g.charset="utf-8";var f=document.getElementsByTagName("head")[0];f.appendChild(g)}function addListener(e,f,g){if(e.addEventListener){e.addEventListener(f,g,false)}else{e.attachEvent("on"+f,g)}}addListener(window,"DOMContentLoaded",function(){user_ttt_init_sina_cn();friend_read_init()});function cutstr(i,m){var k=0;var j=0;var h=0;str_cut=new String();i=htmldecode(i);j=i.length;for(var l=0;l<j;l++){a=i.charAt(l);h++;if(escape(a).length>4){h++}}for(var l=0;l<j;l++){a=i.charAt(l);k++;if(escape(a).length>4){k++}str_cut=str_cut.concat(a);if(k>m&&h>27){str_cut=str_cut.concat("...");return str_cut}}if(k<=27){return i}}function htmlencode(c){c=c.replace(/&/g,"&amp;");c=c.replace(/</g,"&lt;");c=c.replace(/>/g,"&gt;");c=c.replace(/(?:t| |v|r)*n/g,"<br/>");c=c.replace(/  /g,"&nbsp; ");c=c.replace(/t/g,"&nbsp; &nbsp; ");c=c.replace(/x22/g,"&quot;");c=c.replace(/x27/g,"&#39;");return c}function htmldecode(c){c=c.replace(/&amp;/gi,"&");c=c.replace(/&nbsp;/gi," ");c=c.replace(/&quot;/gi,'"');c=c.replace(/&#39;/g,"'");c=c.replace(/&lt;/gi,"<");c=c.replace(/&gt;/gi,">");c=c.replace(/<br[^>]*>(?:(rn)|r|n)?/gi,"n");return c}
function search_box(){
